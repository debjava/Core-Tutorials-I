...
<c:otherwise>
<a href="test.do?parentId=${indx}">${loopStat.count}</a>
</c:otherwise>
</c:choose>
</c:forEach>
<h1>Items</h1>
...
<td><a class="pagingLink" href="test.do?parentId=${parentId}&itemPg=${itemPg-1}"><<</a>
</td>
</c:if>
...
<c:otherwise>
<a class="pagingLink" href="test.do?parentId=${parentId}&itemPg=${pg}">${pg+1}</a>
