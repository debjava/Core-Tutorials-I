 ...
 * file provided on the command line. This example uses the Xerces XML parser.
 *
 * 
 * COMPILE:
 * --------------------------
 * javac -classpath $JAVALIB/xercesImpl.jar XercesXmlDomExample.java
 *
 * javac -classpath %JAVALIB%\xercesImpl.jar XercesXmlDomExample.java
 *
 * 
 * RUN PROGRAM:
 * --------------------------
 * java -classpath $JAVALIB/xercesImpl.jar:$JAVALIB/xmlParserAPIs.jar:. XercesXmlDomExample DatabaseInventory.xml
 *
 * java -classpath %JAVALIB%\xercesImpl.jar;%JAVALIB%\xmlParserAPIs.jar;. XercesXmlDomExample DatabaseInventory.xml
 * 
 * -----------------------------------------------------------------------------
...
public class XercesXmlDomExample {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.err.println("\nUsage: java XercesXmlDomExample filename\n");
            System.exit(1);
        }
