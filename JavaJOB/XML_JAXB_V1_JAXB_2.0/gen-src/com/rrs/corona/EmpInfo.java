 ...
 *         &lt;sequence>
 *           &lt;element name="Info" type="{http://com/rrs/corona/empinfo}EmpType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
...
public class EmpInfo {
    ...
    @XmlElement(name = "Info", namespace = "http://com/rrs/corona/empinfo")
    protected List<EmpType> info;
     ...
     * 
     */
    public List<EmpType> getInfo() {
        if (info == null) {
            info = new ArrayList<EmpType>();
        }
        return this.info;
    }
