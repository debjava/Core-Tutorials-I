    ...
    public static void main( String[] args)
    {
        try
        {
            ...
            for(int i=0;i<contactList.size();i++)
            {
                ...
                {     
                    contact.setEmail("ppppppp@rediff.com"); // for updating   
                }
            }
            
            // for removing a contact
            // for writing to an xml file
            ...
            final FileOutputStream fout = new FileOutputStream("E:/Workarea/Createparser_V2/xmlFile/contactUpdate.xml");
