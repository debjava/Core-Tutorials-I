    ...
    public static void main( String[] args)
    {
        try
        {
            ...
            for(int i=0;i<contactList.size();i++)
            {
                ...
                {
                    adrsBook.getContact().remove(i); // for deleting a contact details
                }
            }
            ...
            final FileOutputStream fout = new FileOutputStream("E:/Workarea/Createparser_V2/xmlFile/contactDelete.xml");
